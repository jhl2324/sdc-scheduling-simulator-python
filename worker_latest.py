...
def two_stage_process(topo, delegate_queue, t_flush, submitted_job_queue):
    virt_topo = []
    ...
    delegate_queue = vec_c[:]
    vec_c.clear()

def run_worker(job_log, topo, delegate_queue, submitted_job_queue):
