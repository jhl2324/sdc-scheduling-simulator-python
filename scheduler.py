...
with open('result/waiting_time/LATEST_sdc_altered_2nd_log_ms_waiting_time', 'w') as waiting_time_file:
    pass
...
def release_resource(topo, finished_job_queue, fin_job_num):
    ...
    with open('result/waiting_time/LATEST_sdc_altered_2nd_log_ms_waiting_time', 'a') as waiting_time_file:
